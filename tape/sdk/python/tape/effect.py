...
The decorator only annotates the function; it does not wrap it, so the tool
schema ADK derives from the signature is untouched.
"""
...
def effect(*, compensate: Optional[Callable] = None, status_check: Optional[Callable] = None,
           ...
           compensation_payload: Optional[Callable] = None) -> Callable:
